...
> **文档版本**：v1.1
> **编制日期**：2026-06-01
> **修订说明**：v1.1 Worker 统计字段精简 + 员工号密码登录、ServiceCatalog 扩展 CONSULT 类、移除 WorkerCertificate（留二期）、Address 加经纬度
> **输入文档**：`requirement/requirement.md` v1.3、`codework/tech.md` v1.4
> **输出文件**：本文档设计结论将转化为 `prisma/schema.prisma`
...
*本文档 v1.1，v1.1 精简 Worker 统计字段 + 新增员工号密码登录、ServiceCatalog 扩展 CONSULT 类、移除 WorkerCertificate（留二期）、Address 加经纬度；v1.0 基于需求文档 v1.3 和已确认的设计决策生成。将作为 `prisma/schema.prisma` 的直接输入。*
