...
/** 可用于 CleaningOrder 状态流转的目标状态（§8.2 合法目标集） */
const CLEANING_TARGET_STATUSES = [
...
/** PATCH /cleaning-orders/:id/status 请求体 */
export class TransitionOrderDto {
  @ApiProperty({
    description: '目标状态',
    enum: CLEANING_TARGET_STATUSES,
    example: OrderStatus.ASSIGNED,
  })
  @IsIn(CLEANING_TARGET_STATUSES)
  toStatus!: string;
